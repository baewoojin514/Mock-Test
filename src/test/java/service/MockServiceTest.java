...
public class MockServiceTest {
    ...
    public void 챔피언이름을가져오면_무조건_베인을_리턴한다(){
        ...
        System.out.print(champion.getName());
    }
    // 1. when, thenReturn을 사용하여 어떠한 챔피언 이름을 입력해도 베인을 리턴하도록 테스트하세요
    @Test(expected = IllegalArgumentException.class)
    public void throwExceptionWhenSetNameYasuo(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldSetMidPositionWhenUseVerify(){
        Champion champion = mock(Champion.class);
        champion.setName("직스");
        champion.setPosition("미드");
        champion.setHasSkinCount(7);
        //위에서 한 set작업들을 뒤에서 검증한다.
    ...
    @Test
    public void verifySizeOfArrayList(){
        ...
        //mock 객체이기 때문에 값이 setting되지 않는다.
    ...
    @Test
    public void shouldInvocationForGetNameLessThanTree(){
        Champion champion = mock(Champion.class);
